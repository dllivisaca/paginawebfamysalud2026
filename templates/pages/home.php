...
$emergencyBannerButtonUrl = homeNormalizePhoneOrHref(homeFieldValue($homeFields, "emergency_banner_button_url", "tel:911"), "tel:911");
...
<main class="main">
  ...
  <section id="featured-services" class="featured-services section light-background">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100"><div class="row gy-4"><?php foreach ($featuredServices as $index => $serviceItem): $serviceFields = $serviceItem["fields"] ?? []; $serviceLinkUrl = homeRepeaterLinkHref($conn, $serviceFields, "#"); ?><div class="col-lg-6" data-aos="fade-up" data-aos-delay="<?php echo 200 + ($index * 100); ?>"><div class="service-card"><div class="service-icon"><i class="<?php echo htmlspecialchars((string) ($serviceFields["icon_class"] ?? ""), ENT_QUOTES, "UTF-8"); ?>"></i></div><div class="service-content"><h3><?php echo htmlspecialchars((string) ($serviceFields["title"] ?? ""), ENT_QUOTES, "UTF-8"); ?></h3><p><?php echo htmlspecialchars((string) ($serviceFields["text"] ?? ""), ENT_QUOTES, "UTF-8"); ?></p><ul class="service-features"><?php foreach (["feature_1", "feature_2", "feature_3"] as $featureKey): $featureValue = (string) ($serviceFields[$featureKey] ?? ""); if ($featureValue === "") continue; ?><li><i class="fas fa-check-circle"></i><?php echo htmlspecialchars($featureValue, ENT_QUOTES, "UTF-8"); ?></li><?php endforeach; ?></ul><a href="<?php echo htmlspecialchars($serviceLinkUrl, ENT_QUOTES, "UTF-8"); ?>" class="service-btn"><?php echo htmlspecialchars((string) ($serviceFields["link_text"] ?? ""), ENT_QUOTES, "UTF-8"); ?><i class="fas fa-arrow-right"></i></a></div></div></div><?php endforeach; ?></div></div>
  </section>
