...
function sendPasswordChangedSecurityEmail(string $recipientEmail, string $recipientName = ""): bool
{
    ...
    $subject = "Se cambió la contraseña de tu cuenta de administrador";
    $htmlBody = '<html><body style="font-family: Arial, sans-serif; color: #1f2937;">'
        ...
        . '<p>Se registr&oacute; un cambio de contrase&ntilde;a en tu cuenta de administrador.</p>'
    ...
    $textBody = "Aviso de seguridad\n\n"
        . "Se registro un cambio de contrasena en tu cuenta de administrador.\n"
